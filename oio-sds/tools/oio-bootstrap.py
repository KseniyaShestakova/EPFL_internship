...
cov = coverage.coverage(data_file='//oio-sds/.coverage.wsgi',
...
env.LD_LIBRARY_PATH=${HOME}/.local/lib64:${LIBDIR}
...
env.PYTHONPATH=${CODEDIR}/lib64/${PYTHON_VERSION}/site-packages
"""
...
start_at_boot=false
command=oio-event-agent ${CFGDIR}/${NS}-${SRVTYPE}-${SRVNUM}.conf
env.PYTHONPATH=${CODEDIR}/lib64/python2.7/site-packages
"""
...
TMPDIR = '/tmp'
CODEDIR = '/root/.local'
SRCDIR = '//oio-sds/tools'
LIBDIR = CODEDIR + '/lib64'
PATH = HOME+"/.local/bin:/root/.local/bin:/usr/sbin"
